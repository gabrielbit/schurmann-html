    ...
    "use strict";
        $('.mk-import-content-btn').click(function(e){
           ...
           var $import_true = confirm('Are you sure to import dummy content? We highly encourage you to do this action in a WordPress fresh installation!');
            ...
            $('.import_message').html('<div class="updated settings-error"><div class="import-content-loading">Please be patient while template is being imported. Depending on the template you are going to install, this process may take between 3-10 minutes.</div></div>');
